...
export function BlockInspector({
  ...
  return (
    <aside className="fixed inset-x-0 bottom-0 z-30 flex max-h-[65vh] flex-col overflow-y-auto border-t bg-card shadow-2xl md:static md:z-auto md:w-80 md:shrink-0 md:overflow-visible md:border-l md:border-t-0 md:shadow-none">
