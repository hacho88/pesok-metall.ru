...
import { createBlock } from "@/lib/block-schemas";
import { savePageConfig } from "@/lib/api";
import { cn } from "@/lib/utils";
import type { PageBlock, PageConfig } from "@/types/page-builder";
    ...
    <div className="flex h-screen flex-col bg-muted/40">
      ...
      <header className="flex h-14 shrink-0 items-center justify-between gap-3 border-b bg-card px-4">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <Sparkles />
            <span className="hidden md:inline">По промпту</span>
          </Button>
          ...
          {config.theme !== "ideal" && (
            ...
            >
              <Sparkles />
              <span className="hidden md:inline">Идеал</span>
            </Button>
          )}

          {/* Устройства */}
          <div className="hidden items-center gap-0.5 rounded-lg border bg-background p-0.5 md:flex">
          ...
          {/* Сохранение */}
          <Button onClick={save} disabled={saving} className="min-w-0 md:min-w-32">
            {saving ? (
      ...
      <div className="flex min-h-0 flex-1 flex-col md:flex-row">
        ...
        {selectedIndex !== null && config.blocks[selectedIndex] ? (
          ...
          <aside className="hidden w-80 shrink-0 flex-col items-center justify-center gap-2 border-l bg-card p-6 text-center md:flex">
